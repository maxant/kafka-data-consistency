...
public class LocationsResource {
    ...
    public Response getZips(@PathParam("zip") String zip) {
        return Response.ok(ClientBuilder // TODO this aint so great because the container complains that it has to close the client => replace with microprofile solution
                .newClient()
